    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <Link className="navbar-brand text-white text-uppercase ml-5" id="nav-banner" to="/">
          Green Thumb Guys <img id="GreenGuy" src={logo} alt="logo" style={{ width: "50px" }} />
        </Link> <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
